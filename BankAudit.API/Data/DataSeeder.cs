    ...
    public static async Task SeedAsync(AppDbContext context)
    {
        ...
        if (!context.ICCDEmployees.Any())
        {
            var employees = new List<ICCDEmployee>
            {
                ...
                new() { EmployeeId = "2959",  Name = "Md. Wasim Uddin Qureshi",     Designation = "FAVP", Unit = "Compliance", Wing = "Compliance" },
                new() { EmployeeId = "6316",  Name = "Muhammad Sadequr Rahman",     Designation = "SEO",  Unit = "Compliance", Wing = "Compliance" },
                new() { EmployeeId = "6324",  Name = "Mohammad Masuf Bin Nuruddin", Designation = "SEO",  Unit = "Compliance", Wing = "Compliance" },
                new() { EmployeeId = "9317",  Name = "Rathindra Nath Mondal",       Designation = "EO",   Unit = "Compliance", Wing = "Compliance" },
                new() { EmployeeId = "9660",  Name = "Ujjwal Kanthi Dhar",          Designation = "EO",   Unit = "Compliance", Wing = "Compliance" },
                new() { EmployeeId = "9661",  Name = "Rownak Tabassum Prima",       Designation = "EO",   Unit = "Compliance", Wing = "Compliance" },
                new() { EmployeeId = "8200",  Name = "Sakif Samih-Ul-Haq",          Designation = "SO",   Unit = "Compliance", Wing = "Compliance" },
