...
import { ComplianceAuditReport, CreateComplianceAuditReportRequest, UpdateComplianceAuditReportRequest } from '../models/compliance-audit-report.model';
...
export class ComplianceAuditReportService {
  ...
  update(id: number, request: UpdateComplianceAuditReportRequest) {
    return this.http.put<ComplianceAuditReport>(`${this.API}/${id}`, request);
  }
